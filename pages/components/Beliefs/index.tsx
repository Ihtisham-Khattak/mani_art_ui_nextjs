      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 my-16 mx-5 gap-5">
        ...
        <div className="bg-darkblue bg-beliefs pt-12 px-10 sm:px-24 pb-52 md:pb-70 rounded-3xl">
          ...
          <div className="bg-[rgb(255,255,255,0.6)] w-full h-full py-10 px-10 rounded-lg rounded-tl-lg">
            ...
            <h3 className="text-4xl sm:text-65xl font-bold text-blue leading-snug mb-5 text-center sm:text-start">
              Honesty{" "}
              <span className="text-black">and hard work are our beliefs.</span>
            </h3>
            <h5 className="text-black pt-2 mb-5 text-center sm:text-start">
